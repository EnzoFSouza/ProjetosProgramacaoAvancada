...
class Planejador{
    ...
    public:
        ...
        Planejador(const std::string& arq_pontos, const std::string& arq_rotas): Planejador(){
        ...
        void ler(const std::string& arq_pontos, const std::string& arq_rotas);
        ...
        double calculaCaminho(const IDPonto& id_origem, const IDPonto& id_destino, Caminho& C, int& NumAberto, int& NumFechado);
};
